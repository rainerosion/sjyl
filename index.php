...
<div class="explan">
    ...
    <div class="explan">
        <script type="text/JavaScript" src="./view.php?act=js&c=00cc99"></script>
    </div>
...
<div class="list">
    <table width="100%" border="2px" bordercolor="0x4C96FF">
        ...
        <tr>
            ...
            <td colspan="3">&lt;script type="text/JavaScript" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>
                /sjyl/view.php?act=js"&gt;&lt;/script&gt;
            </td>
        </tr>
        <tr>
            <th align="center">API
        ...
        <tr>
            ...
            <td align="center"><b>参数说明</b></td>
        </tr>
        <tr>
            <td>c</td>
            <td align="center">颜色</td>
            <td align="center">16进制</td>
            <td><font color='red'>[仅JS调用有效 颜色代码不加符号#]</font> <font color='#fa8c35'>fa8c35</font>,<font color='#4b5cc4'>4b5cc4</font>,<font
                        color='#801dae'>801dae</font>,<font color='#44cef6'>44cef6</font></td>
        </tr>
        <tr>
            <td>k</td>
        ...
        <tr>
            ...
            <td colspan="3">&lt;script type="text/JavaScript" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>
                /sjyl/view.php?act=js<font color="red">&c=颜色值</font><font color="blue">&k=类别值</font>"&gt;&lt;/script&gt;
            </td>
        </tr>
        <tr>
            <td colspan="4" align="center"><b>提交方式 GET</b></td>
        </tr>
        <tr>
